...
In assessing yield for the gene combinations in different varieties, it is of interest to examine the yield components to determine which, if any, have a major influence on yield, or whether it may be a cumulative response. 
...
Furthermore, where there are relationships between a trait and yield or between traits outliers may identify potential sources of genetic gain.


```{r cowplot of regressions, out.width='100%', fig.align='center', fig.height= 3, fig.width=8}
